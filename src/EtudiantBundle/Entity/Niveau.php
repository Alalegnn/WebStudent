 ...
 * @ORM\Entity(repositoryClass="EtudiantBundle\Repository\NiveauRepository")
 */
class Niveau
{
    /**
	...
	/**
	* @ORM\OneToMany(targetEntity="EtudiantBundle\Entity\Etudiant", mappedBy="niveau", cascade={"persist"})
